...
public class Tests {
  ...
  public static Iterable<Object[]> dummyMethodName() {
    return Arrays.asList(new Object[][]{
            {"test/sample_draw_input.txt", "test/sample_draw_output.txt"},
            {"test/sample_win_input.txt", "test/sample_win_output.txt"},
            {"test/hidden_draw_input.txt", "test/hidden_draw_output.txt"},
            {"test/hidden_win_input.txt", "test/hidden_win_output.txt"}
    });
  }
